...
function contentTypeBoost(path) {
...
export function contextualAnchors(prompt, candidates) {
...
export function rankCandidates(prompt, candidates) {
...
export function selectCoverageCandidates(anchors, ranked, limit = 5) {
	const selected = [];
...
export function cheapSemanticJudge(prompt, candidates) {
